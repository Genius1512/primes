...
argglobal
%argdel
edit scripts/nums_list_algorithms.py
...
enew
file NERD_tree_1
balt scripts/nums_list_algorithms.py
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("scripts/__main__.py") | buffer scripts/__main__.py | else | edit scripts/__main__.py | endif
balt scripts/nums_list_algorithms.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <expr> <C-Space> jedi#complete_string(0)
...
exe 'vert 3resize ' . ((&columns * 94 + 95) / 190)
tabnext 1
badd +1 scripts/nums_list_algorithms.py
badd +0 scripts/__main__.py
